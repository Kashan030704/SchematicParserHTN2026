...
5. ingest the hacker dashboard, make it solve the original problem of how we had to wait so long for our parts, larger problem of fulfilling shipment activities for pcbs. schematic ingestion allows users not familiar with pcb part selection (footprints) can isolate that too. 
